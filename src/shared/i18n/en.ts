...
export const en: Translations = {
  ...
  "checkin.duplicateResponse": "You have already responded to this check-in.",
  "checkin.userNotFound": "We could not find your account in the system.",
  "checkin.closedCheckin": "This check-in is already closed.",
};
